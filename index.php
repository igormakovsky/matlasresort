    ...
    <section class="hero-image">
        ...
        <div class="hero-content__intermediate" style="margin:0 auto;">
            ...
            <div class="hero-content__intermediate_map-main">
                ...
                <div class="dot align-right" data-tooltip="Конно-спортивный комплекс" data-tooltip-en="Equestrian club" style="right:10%; top:84%;">
                    <a href="#li-7"><span class="dot__number">7</span></a>
                </div>

                <div class="dot align-right" data-tooltip="Детский инновационный центр" data-tooltip-en="Children innovative center" style="right:38%; top:54%; z-index:101;">
        ...
        <div class="hero-content__title" style="margin:7rem auto 4rem;">
            ...
            <h3 lang="en">Main characteristics of the resort objects</h3>
        </div>
            ...
            <table class="hero-content__table main">
                ...
                <tr>
                    ...
                    <span lang="ru">— Номерной фонд</span>
                        <span lang="en">— Room capacity</span>
                        </span>
                    </td>
                    <td>60</td>
                    <td>2&nbsp;400</td>
                ...
                <tr>
                    ...
                    <td>
                        <a id="li-6" href="/objects/golf/">
                            ...
                            <span lang="en">Golf Club and golf field with&nbsp;18&nbsp;holes&nbsp;(100&nbsp;ha)</span>
                        </a>
                    </td>
                    <td></td>
                    <td>1&nbsp;600</td>
                ...
                <tr>
                    ...
                    <td>
                        <a id="li-7" href="/objects/horse-club/">
                            <span lang="ru">Конно-спортивный комплекс</span>
                            <span lang="en">Equestrian Center</span>
                        </a>
                    </td>
                    <td></td>
                    <td>640</td>
                ...
                <tr>
                    ...
                    <span lang="ru">Детский инновационный центр</span>
                        <span lang="en">Children innovative center</span>
                        </span>
                    </td>
                    <td></td>
                    <td>600</td>
                ...
                <tr>
                    ...
                    <td>
                        <a id="li-9" href="/objects/sport/">
                            ...
                            <span lang="en">Activity center</span>
                        </a>
                    </td>
                    <td></td>
                    <td>640</td>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <a id="li-10" href="/objects/ski/">
                            ...
                            <span lang="en">Горнолыжный комплекс</span>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a id="li-11" href="/objects/commercial/">
                            ...
                            <span lang="en">Restaurant with panoramic view</span>
                        </a>
                    </td>
                    <td></td>
                    <td>800</td>
        ...
        <div class="hero-content__title" style="margin:7rem auto 4rem;">
            ...
            <h3 lang="en">The main advantage of the resort matlas<br>is its all-season and high standards of service</h3>
        </div>
        ...
        <div class="hero-content__description">
            ...
            <p>
                ...
                <span lang="en">In the resort’s neighborhoods there are <strong>more than 150 monuments</strong> of&nbsp;history and culture, as well as a large number of unique natural attractions</span>
            </p>
            <p>
                <span lang="ru">Хунзахский район — один из древнейших центров Дагестана. Хунзаху <strong>— более 2400 лет</strong></span>
                <span lang="en">Khunzakh district is one of the oldest centers of Dagestan. The&nbsp;Khunzakh is <strong>more than 2,400 years</strong></span>
            </p>
        ...
        <div class="hero-content__list">
            <ul>
                ...
                <li>
                    ...
                    <span lang="en">The resort “Matlas” is located on&nbsp;highland Khunzakh plateau at <strong>1,800 meters</strong> above sea level and <strong>140 kilometers</strong> from Makhachkala.</span>
                </li>
                <li>
                    ...
                    <span lang="en">There are most diverse and inimitable corners of&nbsp;nature in&nbsp;the&nbsp;comparatively inconsiderable territory of&nbsp;the&nbsp;district: the&nbsp;deepest canyons, Alpine lakes and water falls amazing in&nbsp;their&nbsp;beauty, mountain ranges in&nbsp;the&nbsp;structure of&nbsp;complex</span>
                </li>
                <li>
                    ...
                    <span lang="en">Such factors as the availability of land for&nbsp;development, a&nbsp;perfect mountainous terrain, mild climate, location in&nbsp;the&nbsp;region, well provided with workforce, will aid prosperous development of&nbsp;the&nbsp;complex.</span>
                </li>
        ...
        <div class="hero-content__poetic" style="margin-top:0rem;">
            ...
            <div class="hero-content__poetic_poem" lang="en">
                <p>Dagestan, everything that people gave me,
                    <br>I have to be honest with you divide</p>
                <div class="hero-content__poetic_author">
                    <p>Rasul Gamzatov</p>
                </div>
